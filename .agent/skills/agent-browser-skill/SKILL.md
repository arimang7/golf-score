...
description: Headless browser automation CLI for AI agents. Run agent-browser commands to control the browser, take snapshots, click elements, fill forms, etc.
---
